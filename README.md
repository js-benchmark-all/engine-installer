...
```sh
# create config file if not exists, else install all engines in config file
egist init
...
# similar arguments to egist add
egisl remove v8 quickjs llrt jsc hermes spidermonkey xs
```
